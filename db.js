...

        {
            ...
            "contents": [
                ...
                
                {
                    ...
                    "src": "assets/background/_1230004.jpg",
                    "youtube": false
                },
                {
                    "title": "hdksjugfbdxhjkgbld",
                    "description": "the planes be flying",
                    "src": "assets/background/_1370407.jpg",
                    "youtube": "C0cCKmCj8ew"
                }   
        ...
        {   // this is a basic normal collection
            ...
            "contents": [   // here is the list of photos
                ...
                {   // this is photo #0
                    ...
                    "src": "assets/background/_1230004.jpg",    // path to the image file starting with assets/   also if this is going to be a youtube video, you want this path to go to what image you want for the thumbnail (the thumbnail MUST be landscape 3:2 aspect ratio)
                ...
                {   // this is photo #1   (example of a youtube video)
                    "title": "hdksjugfbdxhjkgbld",
                    "description": "the planes be flying",
                    "src": "assets/background/_1370407.jpg",                    // the thumbnail should be your photo of the cat
